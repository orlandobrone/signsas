jQuery(function(){
	...
	*/
	...
	jQuery('#FORMCONTAINER_ID .cfg-uploadfilename').val(''); // FF may keep the file name in the cfg-uploadfilename input after submitting and refreshing the page
	
	jQuery('#FORMCONTAINER_ID .cfg-captcha-refresh').click(function(){
		
		jQuery('#FORMCONTAINER_ID .cfg-captcha-img').attr('src','FORM_INC_DIR/inc/captcha.php?r='+Math.random());
	});
	
	jQuery('#FORMCONTAINER_ID .cfg-submit').click(function(){
	...
	jQuery('body').on('click', '#FORMCONTAINER_ID .cfg-deleteupload', function()
	{
