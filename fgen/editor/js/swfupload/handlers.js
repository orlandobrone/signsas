...
function uploadSuccess(file, serverData) {
	...
	jQuery('#'+progressTargetContainer).closest('.element-editor').find('.delimagefromurl').remove();
	...
	// imagefromupload after imagefromurl
	jQuery('#'+progressTargetContainer).closest('.element-editor').find('.delimagefromurl').remove();
	jQuery('#'+progressTargetContainer).closest('.element-editor').find('.image_url').val('');
	...
	jQuery('#'+progressTargetContainer).closest('.element-container').find('.cfg-element-content').empty().append('<img src="'+contactformgenerator_dir_upload+jQuery.trim(serverData)+'" class="imageuploadtocopy" />')
	
	
	// adjust element container height
	var element_container = jQuery('#'+progressTargetContainer).closest('.element-container');
