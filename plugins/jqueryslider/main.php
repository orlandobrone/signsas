...
<div id="jqslider">
  <ul class="slides">
    ...
    <li>
      <?php if($slrow['urltype'] == "nourl"):?>
      <img src="<?php echo SITEURL;?>/plugins/jqueryslider/slides/<?php echo $slrow['filename'];?>" alt="" title="<?php echo $slrow['title'.$core->dblang];?>" />
      <?php else:?>
      <a href="<?php echo ($slrow['urltype'] == "ext") ? $slrow['url'] : SITEURL . "/" . $slrow['url'];?>" <?php echo ($slrow['urltype'] == "ext") ? "target=\"_blank\"" : "target=\"_self\"";?>><img src="<?php echo SITEURL;?>/plugins/jqueryslider/slides/<?php echo $slrow['filename'];?>" alt="" title="<?php echo $slrow['title'.$core->dblang];?>" /></a>
      <?php endif;?>
