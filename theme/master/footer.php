...
?>	
<!-- Footer -->
<footer id="footer" class="clearfix f-<?php echo (isset($plugbot) and $plugbot == true) ? "short" : "long"?>">
  <div class="container"> 
    <div class="row">
      <div class="fotter-wrap-<?php echo (isset($plugbot) and $plugbot == true) ? "short" : "long"?> clearfix">
