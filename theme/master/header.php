    ...
    <div class="row grid_24">
      <div class="sub-header clearfix">
        <div class="col grid_8">
          <div class="logo"> <a href="<?php echo SITEURL;?>/index.php"><?php echo ($core->logo) ? '<img src="'.SITEURL.'/uploads/'.$core->logo.'" alt="'.$core->company.'" />': $core->company;?></a> </div>
        </div>
