  ...
  <div class="row">
    <div class="fotter-wrap">
      <div class="col grid_16">
        <div class="copyright top10">Copyright &copy;<?php echo date('Y').' <a href="'.SITEURL.'/index.php">'.$core->site_name.'</a>';?> All Rights Reserved. | Powered by: CMS Pro m2 v <?php echo $core->version;?></div>
      </div>
