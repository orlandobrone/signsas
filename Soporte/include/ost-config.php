...
define('SECRET_SALT','8UUQCijestknyj9PiKOVMnz=oL8CV_HH');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','william.sierra@soluciones.com.co');
...
define('DBNAME','signsas_soporte');
define('DBUSER','signsas_soporte');
define('DBPASS','Bogota2016*');
