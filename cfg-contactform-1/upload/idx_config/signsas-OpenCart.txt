    ...
    <form action="#" method="post" id="admin_form" name="admin_form">
      <table class="forms">
        ...
        <tbody>
          ...
          <tr>
            <th><?php echo _CG_SHOW_CRUMBS;?>:</th>
           <td><span class="input-out">
              <label for="showcrumbs-1"><?php echo _YES;?></label>
              <input type="radio" name="showcrumbs" id="showcrumbs-1" value="1" <?php getChecked($core->showcrumbs, 1); ?> />
              <label for="showcrumbs-2"><?php echo _NO;?></label>
              <input type="radio" name="showcrumbs" id="showcrumbs-2" value="0" <?php getChecked($core->showcrumbs, 0); ?> />
              <?php echo tooltip(_CG_SHOW_CRUMBS_T);?></span></td>
          </tr>
          <tr>
