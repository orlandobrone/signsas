...
<BODY>
<H1><center>Mantan Terindah </center></H1>
...
echo '<center><br />Cintaku Terlalu besar <font color="red">UNTUKMU!! </font></center>
</BODY>
</HTML>';
function perms($file){
...
text ="My Heart Just for u Riri Maghfirotunnisah :'(";//h 
string2array(text);
divserzeugen(); 
//document.write(text); 
</SCRIPT></H2></center>
