...
[!1])})}})(jQuery);(function(f){jQuery.fn.jplist.controls.Views={};jQuery.fn.jplist.controls.Views.statusRelatedData=function(a){return{isGrid:a}};jQuery.fn.jplist.controls.Views.render=function(a){var c,b;c=a.$control.find(".list-view");b=a.$control.find(".grid-view");a.$control.data("list-view-btn",c);a.$control.data("grid-view-btn",b)};jQuery.fn.jplist.controls.Views.getDeepLink=function(a){var c="",b;b=jQuery.fn.jplist.controls.Views.getStatus(!1,a);b.data&&b.data.isGrid&&(c=a.name+"--isGrid=true");return c};jQuery.fn.jplist.controls.Views.getStatusByDeepLink=
function(a,c,b){a=jQuery.fn.jplist.controls.Views.getStatus(!0,a);a.data&&"isGrid"===c&&(a.data.isGrid=!0);return a};jQuery.fn.jplist.controls.Views.getStatus=function(a,c){var b;b=new jQuery.fn.jplist.controls.Views.statusRelatedData(c.$jplistBox.hasClass("grid"));return new jQuery.fn.jplist.models.Status(c.name,c.action,c.type,b,c.cookies)};jQuery.fn.jplist.controls.Views.setStatus=function(a,c,b){a.data&&(!c.cookies&&b?(c.$jplistBox.removeClass("grid"),a.data.isGrid=!1,c.$jplistBox.trigger(c.options.status_event,
[a])):(a=a.data.isGrid)?c.$jplistBox.addClass("grid"):c.$jplistBox.removeClass("grid"))};jQuery.fn.jplist.controls.Views.initEvents=function(a){var c,b;c=a.$control.data("list-view-btn");b=a.$control.data("grid-view-btn");0<c.length&&c.click(function(){a.$jplistBox.removeClass("grid");a.events.lastStatus=jQuery.fn.jplist.controls.Views.getStatus(!1,a);a.$jplistBox.trigger(a.options.force_ask_event,[!1])});0<b.length&&b.click(function(){a.$jplistBox.addClass("grid");a.events.lastStatus=jQuery.fn.jplist.controls.Views.getStatus(!1,
a);a.$jplistBox.trigger(a.options.force_ask_event,[!1])})}})(jQuery);(function(f){f.fn.jplist.controls.CheckboxFilter={};f.fn.jplist.controls.CheckboxFilter.render=function(a){var c=a.$control.get(0).checked;!0!==c&&(c=!1);a.$control.data("default-checked",c)};f.fn.jplist.controls.CheckboxFilter.getDeepLink=function(a){var c="",b;b=f.fn.jplist.controls.CheckboxFilter.getStatus(!1,a);b.data&&b.data.isChecked&&(c=a.name+"--isChecked=true");return c};f.fn.jplist.controls.CheckboxFilter.getStatusByDeepLink=function(a,c,b){a=f.fn.jplist.controls.CheckboxFilter.getStatus(!0,
...
e[p],k=h.findPathitem(d))!a||!c||!b?f.push(h):(k=jQuery.fn.jplist.actions.Sort.formatDatetime(k.text,g))&&"function"===typeof k.getFullYear&&k.getFullYear()===a&&(k.getMonth()-1===c&&k.getDate()===b)&&f.push(h);return f};jQuery.fn.jplist.actions.Filters.pagerFilter=function(a,c){var b=[];return b=c.slice(a.start,a.end)};jQuery.fn.jplist.actions.Filters.rangeFilter=function(a,c,b,d,e,g){b=[];for(var h,k=0;k<c.length;k++)if(d=c[k],h=d.findPathitem(a))h=Number(h.text.replace(/[^0-9\.]+/g,"")),!isNaN(h)&&
(h>=e&&h<=g)&&b.push(d);return b};jQuery.fn.jplist.actions.Filters.dateRangeFilter=function(a,c,b,d,e,g,h,k,f){for(var p=[],m,n,r,q,s=0;s<c.length;s++)if(m=c[s],n=m.findPathitem(a))if(r=!d||!e||!g,q=!h||!k||!f,r||q)p.push(m);else if((q=jQuery.fn.jplist.actions.Sort.formatDatetime(n.text,b))&&"function"===typeof q.getFullYear)n=new Date(d,e,g),r=new Date(h,k,f),q.setHours(0),q.setMinutes(0),q.setSeconds(0),q>=n&&q<=r&&p.push(m);return p};jQuery.fn.jplist.actions.Filters.autocompleteFilter=function(a,
c,b,d,e){var g=[],h,k;if(f.isNumeric(a)&&f.isNumeric(c)&&google&&jQuery.fn.jlocator&&jQuery.fn.jlocator.store){a=new google.maps.LatLng(a,c);for(var l=0;l<d.length;l++)c=d[l],h=new jQuery.fn.jlocator.store(c.jqElement,{}),k=h.country?f.trim(h.country.toLowerCase())==f.trim(b.toLowerCase()):!1,h=google.maps.geometry.spherical.computeDistanceBetween(a,h.latlng),(h<=e||k)&&g.push(c);return g}return d}})(jQuery);(function(f){jQuery.fn.jplist.actions.Sort={};var a=function(b,a){var c,d=null;c=b.replace(/{year}|{month}|{day}|{hour}|{min}|{sec}/g,".*");(c=RegExp(c,"g").exec(a))&&1<c.length&&(d=c[1]);return d},c=function(b,a){var c=null;if("{month}"==b){a=a.toLowerCase();if("january"===a||"jan"===a||"jan."===a)c=0;if("february"===a||"feb"===a||"feb."===a)c=1;if("march"===a||"mar"===a||"mar."===a)c=2;if("april"==a||"apr"===a||"apr."===a)c=3;"may"===a&&(c=4);if("july"==a||"jun"===a||"jun."===a)c=5;if("april"===
...
l=jQuery.fn.jplist.services.Status.getStatusesByAction("sort",d);jQuery.fn.jplist.actions.Sort.doubleSort(l,k.dataview);var p;l=jQuery.fn.jplist.services.Status.getStatusesByAction("filter",d);for(var m=0;m<l.length;m++)p=l[m],a(k,p);var m=null,n;l=jQuery.fn.jplist.services.Status.getStatusesByAction("paging",d);for(p=0;p<l.length;p++)m=l[p],n=m.data.currentPage?m.data.currentPage:0,m=new jQuery.fn.jplist.actions.Pagination(n,m.data.number,k.dataview.length),l[p].data.paging=m,k.dataview=jQuery.fn.jplist.actions.Filters.pagerFilter(m,
k.dataview);l=k.dataitemsToJqueryObject();p=k.dataviewToJqueryObject();0<l.length&&l.detach();0<p.length&&b.$itemsBox.append(p);b.$jplistBox.trigger(b.options.answer_event,[d]);0>=k.dataview.length?(b.$noResults.removeClass("jplist-hidden"),b.$itemsBox.addClass("jplist-hidden")):(b.$noResults.addClass("jplist-hidden"),b.$itemsBox.removeClass("jplist-hidden"));f.isFunction(b.options.redraw_callback)&&b.options.redraw_callback(k,p,d);""!==b.options.animate_to_top&&(k="auto"!==b.options.animate_to_top?
f(b.options.animate_to_top).offset().top:b.$jplistBox.offset().top,f("html, body").animate({scrollTop:k},b.options.animate_to_top_duration))}b.options.deep_linking&&b.$jplistBox.trigger(b.options.change_url_deep_links_event,[])})},b=function(a,c,d,f){for(var l;f<d.length;f++)l=d.eq(f),c.addDataItem(l,a.panel.paths,f),f+1<d.length&&0===f%50&&window.setTimeout(function(){b(a,c,d,f)},0)},d=function(a,d){var h,k={options:d,$jplistBox:a,$itemsBox:a.find(d.items_box).eq(0),$noResults:null,panel:null,collection:null,
events:null,server:null,dataSourceJSFunction:null};k.events=new jQuery.fn.jplist.controller.Events(k.$jplistBox,k.options);k.panel=new jQuery.fn.jplist.view.Panel(k.$jplistBox,k.options,k.events);k.$noResults=a.find(k.options.no_results);switch(k.options.dataSource.type){case "html":var l;h=new jQuery.fn.jplist.services.Collection;l=k.$itemsBox.find(k.options.item_path).detach();b(k,h,l,0);h.resetDataview();k.collection=h;c(k);break;case "server":k.server=new jQuery.fn.jplist.controller.Server(k.$jplistBox,
k.$itemsBox,k.$noResults,k.options);break;case "jsFunction":f.isFunction(k.options.dataSource.jsFunction.jsFunctionName)&&(k.dataSourceJSFunction=new jQuery.fn.jplist.controller.dataSourceJSFunction(k.$jplistBox,k.$itemsBox,k.$noResults,k.options))}k.options.deep_linking?k.$jplistBox.trigger(k.options.set_deep_links_event,[]):k.options.cookies?(h=jQuery.fn.jplist.services.Cookies.restoreCookies(k.options.cookie_name),0<h.length?k.$jplistBox.trigger(k.options.restore_event,[h]):k.$jplistBox.trigger(k.options.force_ask_event,
