...
<form action="javascript: fn_modificar();" method="post" id="frm_per">
	...
	<table style="display:block;">
        <tbody>
        	 <tr>
                <td>ID:</td>
                <td><input type="text" id="id" name="id" value="<?=$id_anticipo?>" readonly="readonly" /></td>
                <td>ID Legalizaci&oacute;n:</td>
                <td><input type="text" id="id_legalizacion" name="id_legalizacion" value="<?=$id_legalizacion?>" readonly="readonly" /></td>
             </tr>
             <tr>   
...
<form action="javascript: fn_agregar_item();" method="post" id="frm_item">
	...
	<input type="text" id="id" name="id" value="<?=$id_anticipo?>" />
    ...
    <table style="width:100%">
        <tbody>          	
            <tr>
              ...
              <td>
                  <input type="text" name="total_anticipo" id="total_anticipo"  readonly="readonly" value="<?=$total_anticipo?>"/>               
              </td>           
        	</tr>       
        </tbody>   
   </table>
