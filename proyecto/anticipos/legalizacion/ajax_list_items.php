...
echo json_encode($jsonData);*/
	...
	$query = "SELECT SQL_CALC_FOUND_ROWS * FROM items WHERE id_legalizacion =".$_GET['id']." LIMIT $start, $pagesize";
...

		{
...

			{
...

				{
					...
					$query = "SELECT * FROM items  WHERE id_legalizacion =".$_GET['id']." ORDER BY" . " " . $sortfield . " DESC LIMIT $start, $pagesize";
...

				{
					...
					$query = "SELECT * FROM items  WHERE id_legalizacion =".$_GET['id']." ORDER BY" . " " . $sortfield . " ASC LIMIT $start, $pagesize";
