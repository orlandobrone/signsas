<? header('Content-type: text/html; charset=iso-8859-1');
	...
	while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
		...
		switch($row['aprobado']):
				...
				case 3:
					$aprobar = "No Aprobado";
					$btn_aprobar = '<a href="javascript: fn_aprobar_item('.$row['id'].','.$i.');"><img src="https://cdn2.iconfinder.com/data/icons/color-svg-vector-icons-part-2/512/ok_check_yes_tick_accept_success-16.png" /></a>&nbsp<a href="javascript: fn_eliminar_item('.$row['id'].');"><img src="../extras/ico/delete.png" /></a>';
				break;
				case 1:
					$aprobar = "Aprobado";
					$btn_aprobar = '&nbsp';
		...
		$customers[] = array(
			...
			'existencia' => (int)$rs_pai2['cantidad'],
			'cantidadc' => $rs_pai3['cantidadc'],
			'costo2'=>$rs_pai3['costo2'],
			'iva2' => $rs_pai3['iva2'],
			'orden_compra2' => $rs_pai3['orden_compra2'],
			'cantidade' => $rs_pai3['cantidade']
		 );
