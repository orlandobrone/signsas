<? header('Content-type: text/html; charset=iso-8859-1');
	...
	while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
		...
		$sqli = mysql_query("SELECT nombre_material FROM inventario WHERE id =".$row['id_material']) or die(mysql_error());
		...
		$customers[] = array(
			...
			'fecha' => $row['fecha'],
			'acciones' => '<a href="javascript: fn_eliminar('.$row['id'].');"><img src="../extras/ico/delete.png" /></a>'
		  );
