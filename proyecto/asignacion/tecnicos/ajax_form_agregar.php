    ...
    <table class="formulario">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><input name="cargo" type="text" id="cargo" size="40" class="required" /></td>
            ...
            <tr>
                ...
                <td><input name="sueldo" type="text" id="sueldo" size="40" class="required money" /></td>
            ...
            <tr>
                ...
                <td><input name="valor_plan" type="text" id="valor_plan" size="40" class="required money" /></td>
