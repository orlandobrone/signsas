...
<form action="javascript: fn_modificar();" method="post" id="frm_per" style="float:left; width:338px;margin-right: 30px;">
    ...
    <table class="formulario">
        <tbody>
            ...
            <tr>
                <td>Regi&oacute;n</td>
                <td><input type="hidden" name="lugeje" type="text" id="lugeje" size="40" value="<?=$rs_per['region']?>"/>
    ...
    <?php
		if(unserialize($rs_per['planillas']) != false):
			...
			?>
  		<input type="text" class="pos_<?=$file?>" name="plantillas[]" value="<?=$file?>">
    <?php
			} 
		endif;
	?>
			...
			?>
                ...
                <li class="pos_<?=$file?>">
                    ...
                    <input type="text" value="0" data-width="48" data-height="48" data-fgcolor="#0788a5" 
                           data-readonly="1" data-bgcolor="#3e4043" readonly="readonly" 
