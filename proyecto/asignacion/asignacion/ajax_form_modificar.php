    ...
    <table class="formulario">
        ...
        <tbody>
        	 ...
        	 <tr>
                ...
                <td><input name="fecini" type="text" id="fecini" size="40" class="required" readonly="readonly" value="<?=$rs_per['fecha_ini']?>" />
             ...
             <tr style="display:none;">
                ...
                <td><input name="fecfin" type="text" id="fecfin" size="40" readonly="readonly" value="<?=$rs_per['fecha_fin']?>"/>
            ...
            <tr>
                ...
                <td colspan="2">
                 ...
                 <input type="checkbox" id="disponible" name="disponible" <?php echo ($rs_per['libre'] == 'si')? 'checked="checked"':''; ?>/>  Disponible             
                    ...
                    <?php	
                        ...
                        while ($row = mysql_fetch_array($qrPry)):
							...
							if($row['id'] == $rs_per['id_hito']):
                            	...
                            	echo '<option value="'.$row['id'].'" selected="selected">'.utf8_encode($row['nombre']).'</option>';	
            ...
            <tr>
                ...
                <td>
                	...
                	<textarea name="observacion" id="observacion" cols="25" rows="5"><?=$rs_per['observacion']?></textarea>
...
<script language="javascript" type="text/javascript">
	...
	$(document).ready(function(){
        ...
        $(".horas").jqxDateTimeInput({ width: '250px', height: '25px', 

									   formatString: 'HH:mm:ss', showCalendarButton: false});
