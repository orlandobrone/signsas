<? header('Content-type: text/html; charset=iso-8859-1');
	...
	$query = "SELECT SQL_CALC_FOUND_ROWS * FROM asignacion LIMIT $start, $pagesize";
...

		{
...

			{
...

				{
					...
					$query = "SELECT * FROM asignacion ORDER BY" . " " . $sortfield . " DESC LIMIT $start, $pagesize";
...

				{
					...
					$query = "SELECT * FROM asignacion ORDER BY" . " " . $sortfield . " ASC LIMIT $start, $pagesize";
