...
<?php	
	...
	while ($row = mysql_fetch_array($result, MYSQL_ASSOC)):
					...
					$sqlPry = "SELECT sigla, nombre FROM centros_costos WHERE id =".$row['id_centrocostos'];

                    $qrPry = mysql_query($sqlPry);

                    $rsPry = mysql_fetch_array($qrPry);

                    $centrocostos = $rsPry['sigla'].' / '.$rsPry['nombre'];
					...
					$sqlPry = "SELECT nombre FROM hitos WHERE id =".$row['id_hito'];
