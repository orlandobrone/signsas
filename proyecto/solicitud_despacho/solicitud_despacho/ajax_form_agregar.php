...
<table>
        ...
        <tbody>
        	 ...
        	 <tr>
                ...
                <td><input name="fecha_solicitud" type="text" id="fecha_solicitud" readonly="readonly required" />
          ...
          <tr>
                ...
                <td><input name="fecha_entrega" type="text" id="fecha_entrega" readonly="readonly required" />
    ...
    <table>
            ...
            <tr>
              ...
              <td><input name="presupuesto" type="text" id="presupuesto" size="40" class="required" alt="signed-decimal"/></td>
...
$(document).ready(function () {
            ...
            $("#jqxgrid2").jqxGrid({
                ...
                columns: [
                  ...
                  { text: 'C&oacute;digo', datafield: 'codigo', filtertype: 'none', filtercondition: 'equal',  columntype: 'textbox', editable: false },
				  
				  /*{ text: 'Id Hito', datafield: 'id_hito', filtertype: 'textbox', filtercondition: 'equal',  columntype: 'textbox', editable: false },*/
                  ...
                  { text: 'Estado', datafield: 'aprobado', filtertype: 'none', cellsalign: 'left' }
