<?
	...
	if($_POST['confirmar'] != ''):
		...
		$sql = sprintf("UPDATE usuario SET usuario='%s', password='%s', nombres='%s', codigo_perfil='%s', email='%s', id_regional=%d WHERE id=%d;",
		...
		$sql = sprintf("UPDATE usuario SET usuario='%s', nombres='%s', codigo_perfil='%s', email='%s', id_regional=%d WHERE id=%d;",
			fn_filtro($_POST['usuario']),
			fn_filtro($_POST['nombres']),
			fn_filtro($_POST['codigo_perfil']),
			fn_filtro($_POST['email']),
