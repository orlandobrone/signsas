<? header('Content-type: text/html; charset=iso-8859-1');
	...
	while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
		...
		$customers[] = array(
			...
			'acciones' => '<a title="Editar'.$rs_pai4['total'].'" href="javascript: fn_mostrar_frm_modificar('.$row['id'].');"><img src="../extras/ico/page_edit.png" /></a>&nbsp;<a title="Eliminar" href="javascript: fn_eliminar('.$row['id'].');"><img src="../extras/ico/delete.png" /></a>'.$ots
		  );
	}
    $data[] = array(
