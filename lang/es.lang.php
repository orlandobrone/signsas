...
<?php
  ...
  define('_N_FIELDS', 'Custom Fields');
  ...
  define('_LG_PASS_RESET', 'ha solicitado un cambio de clave.');
  ...
  define('_LG_PAYMENT_ERR', 'Failed transaction for ');
   ...
   // Custom Fields
  define('_CFL_TITLE1', 'Manage CMS Custom Fields');  
  ...
  define('_CFL_SUBTITLE1', 'Viewing Custom Fields'); 
  define('_CFL_ADDNEW', 'Add New Field'); 
  
  define('_CFL_SAVE', 'Save Position');
  
  define('_CFL_TITLE2', 'Manage CMS Custom Fields &rsaquo; Edit Field');
  define('_CFL_SUBTITLE2', 'Editing Custom Field &rsaquo; ');
  define('_CFL_INFO2', 'Here you can update existing custom field.');
  
  define('_CFL_TITLE3', 'Manage CMS Custom Fields &rsaquo; Add Field');
  define('_CFL_SUBTITLE3', 'Adding Custom Field');
  define('_CFL_INFO3', 'Here you can add new custom field.');
  
  define('_CFL_NAME', 'Field Name');
  define('_CFL_NAME_R', 'Please Enter Field Name');
  define('_CFL_TIP', 'Field Tooltip');
  define('_CFL_SECTION', 'Section');
  define('_CFL_POSITION', 'Position');
  define('_CFL_REQ', 'Required');
  define('_CFL_SECTION_P', 'User Profile');
  define('_CFL_SECTION_R', 'Registration');
  define('_CFL_ENTER_F', 'Please Enter ');
  define('_CFL_NOFIELDS', '<span>Info!</span>You don\'t have any custom fields yet...');
  define('_CFL_FIELD', 'Field');
  define('_CFL_SORT_OK', '<span>Success!</span>Fields sorted successfully!');
  define('_CFL_UPDATE', 'Update Field');
  define('_CFL_ADD', 'Add Field');
  define('_CFL_UPDATED', '<span>Success!</span>Custom Field updated successfully');
  define('_CFL_ADDED', '<span>Success!</span>Custom Field added successfully');
  ...
  find some of the information required when trying to diagnose a problem or request help with your CMS pro installation.');
  ...
  define('SYS_DBTABLE_INF', 'Database Tables');
  ...
  define('_UA_SUBTITLE2', 'Ingrese su usuario y clave para ingresar en su cuenta o a una pagina protegida.');
  define('_UA_LOGINNOW', 'Ingrese');
  define('_UA_CLICKTOREG', 'Registrese');
  define('_UA_TITLE3', 'Recordar');
  define('_UA_SUBTITLE3', 'Ingrese su usuario y el correo electronico (email). Un correo de verificacion le sera enviado.<br />Ahi ud podra cambiar la clave.');
  define('_UA_PASS_RTOTAL', 'C&oacute;digo de verificaci&oacute;n');
  define('_UA_PASS_RTOTAL_R', 'Please enter C&oacute;digo de verificaci&oacute;n');
  define('_UA_PASS_RTOTAL_R1', 'Entered C&oacute;digo de verificaci&oacute;n is incorrect');
  define('_UA_PASS_RSUBMIT', 'Submit Request');
  define('_UA_PASS_R_OK', '<span>listo!</span>Ud ha cambiado su clave');
  ...
  define('_UA_SUBTITLE4', 'Crear cuenta'); 
  define('_UA_PASSWORD2', 'Repita la clave'); 
  define('_UA_PASSWORD2_T', 'La clave debe tener al menos 6 caract&eacute;res.'); 
  define('_UA_REG_RTOTAL', 'C&oacute;digo de verificaci&oacute;n<br>Digite el n&uacute;mero que aparece al final de esta l&iacute;nea.');
  define('_UA_REG_RTOTAL_R', 'Ingrese el C&oacute;digo de verificaci&oacute;n.');
  define('_UA_REG_RTOTAL_R1', 'C&oacute;digo de verificaci&oacute;n incorrecto.');
  define('_UA_AVATAR_SIZE', 'Uploaded image is larger than 300Kb');
  define('_UA_REG_ACC', 'Reg&iacute;strese');
  ...
  define('_CF_NAME_R', 'Ingrese su nombre');
  define('_CF_TOTAL', 'C&oacute;digo de verificaci&oacute;n<br>Digite el n&uacute;mero que aparece al final de esta l&iacute;nea.');
  define('_CF_TOTAL_R', 'Please enter C&oacute;digo de verificaci&oacute;n');
  define('_CF_TOTAL_ERR', 'Entered C&oacute;digo de verificaci&oacute;n is incorrect');
  ...
  define('_CG_SHOW_CRUMBS', 'Show Navigation Crumbs');
  define('_CG_SHOW_CRUMBS_T', 'Whether or not to display navigation crumbs.');
  ...
  define('_CG_SMTP_PORT_T', 'Mail server port ( Can be 25, 26. 465 for GMAIL. 587 for Yahoo ). Ask your host if uncertain.');
...
Here you only need the language file in the same format <strong>fr.lang.php</strong> without a country flag.');
  ...
  define('_GW_HELP_AN', '
			<p><a href="http://www.authorize.net/" title="http://www.authorize.net//" rel="nofollow">Click here to setup an account with Authorize.Net</a></p>
			<p><strong>Gateway Name</strong> - Enter the name of the payment provider here.</p>
			<p><strong>Active</strong> - Select Yes to make this payment provider active. <br/>
			  If this box is not checked, the payment provider will not show up in the payment provider list during checkout.</p>
			<p><strong>Set Live Mode</strong> - If you would like to test the payment provider settings, please select No. </p>
  ...
  define('_OL_INFO', '<span>Success!</span>Please check your email for further instructions.');
  ...
  define('_FM_ZIPOK', '<span>Success!</span>Zip file <strong>[FILENAME]</strong> created successfully.');
  define('_FM_FILE_REN_OK', '<span>Success!</span>File <strong>[FILENAME]</strong> renamed successfully.');
  define('_FM_FILE_REN_I', '<span>Alert!</span>File <strong>[FILENAME]</strong> was not renamed');
  ...
  define('_FM_COPY_OK', '<span>Success!</span>Files/Directories were successfully copied');
  ...
  define('_LY_INFO', 'Here you can manage your cms layout.<br />First select the page form dropdown list for which you want to manage layout.<br />Each top/bottom plugin can occupy maximum of 24 grid spaces. -1 is default value of 100%');
  ...
  define('_LY_SPTITLE', 'Maximum Space Ocupied');
  define('_LY_SUB', 'Enter Amount');
  ...
  define('_PG_BG_IMAGE', 'Background Image');
  ...
  define('_HP_PAGES_BODY', '<ul>
	...
	<li><span>Registrado:</span> - Solo visitantes registrados y logueados pueden accessar este contenido.</li>
