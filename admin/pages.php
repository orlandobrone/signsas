      ...
      <form action="#" method="post" id="admin_form" name="admin_form">
        <table class="forms">
          ...
          <tbody>
            ...
            <tr>
              <th><?php echo _PG_BG_IMAGE;?>:</th>
              <td><input type="text" class="inputbox" id="custom_bg" size="55" name="custom_bg" readonly="readonly" />
                <a href="javascript:void(0);" class="getfiles"><img src="images/filemngr-sml.png" alt=""/></a></td>
            </tr>
            <tr>
...
$(document).ready(function() {
    $(".getfiles").click(function () {
     modalDialogShow('editor/filemanager.php?field=custom_bg',610,475);
    });
