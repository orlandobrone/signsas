...
<ul id="nav">
  ...
  <?php endif;?>
  <?php if($user->getAcl("Configuration") or $user->getAcl("Templates") or $user->getAcl("Newsletter") or $user->getAcl("Language") or $user->getAcl("Maintenance") or $user->getAcl("Logs")):?>
  <li><a href="javascript:void(0);" class="<?php echo ($core->do == 'config' or $core->do == 'templates' or $core->do == 'newsletter' or $core->do == 'language' or $core->do == 'maintenance' or $core->do == 'logs') ? "expanded" : "collapsed";?>"><img src="images/icons/config-ico.png" alt="" /><span>...</span><?php echo _N_CONF;?></a>
    <ul class="subnav">
      ...
      <li><a href="index.php?do=fields" class="<?php if ($core->do == 'fields') echo "active";?>"><?php echo _N_FIELDS;?></a></li>
      <?php endif;?>
