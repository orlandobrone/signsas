...
<div class="block-border">
  <div class="block-header">
    <ul class="idTabs" id="tabs">
      ...
      <li><a href="#dbtables"><?php echo SYS_DBTABLE_INF;?></a></li>
    </ul>
    ...
    <table style="width:100%">
      <tr>
        <td><div id="cms" class="tab_content">
          ...
          <div id="dbtables" class="tab_content">
            <?php print $tools->optimizeDb();?>
          </div>
          </td>
      </tr>
    </table>
