...
ISGroup.prototype.render=function() {
  ...
  s[j++]="<table cellpadding=0 cellspacing=0 class='isgroup' width='100%' style='width:100%;font-size:8px;'><tr>";
  //s[j++]="<td class='bdrgrpleft'></td>";
  s[j++]="<td class='isgroupcontent' unselectable='on'>";
  s[j++]=isTbars[this.tbId].render();
  s[j++]="</td>";  
  //s[j++]="<td class='bdrgrpright'></td>"; 
  s[j++]="</tr>"; 
