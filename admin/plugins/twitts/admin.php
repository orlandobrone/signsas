    ...
    <form action="#" method="post" id="admin_form" name="admin_form">
      <table class="forms">
        ...
        <tbody>
          ...
          <tr>
            <th><?php echo PLG_TW_KEY;?>:<?php echo required();?></th>
            <td><input name="consumer_key" type="text" class="inputbox" value="<?php echo $twitt->consumer_key;?>" size="55" /></td>
          </tr>
          <tr>
            <th><?php echo PLG_TW_SECRET;?>:<?php echo required();?></th>
            <td><input name="consumer_secret" type="text" class="inputbox" value="<?php echo $twitt->consumer_secret;?>" size="55" /></td>
          </tr>
          <tr>
            <th><?php echo PLG_TW_TOKEN;?>:<?php echo required();?></th>
            <td><input name="access_token" type="text" class="inputbox" value="<?php echo $twitt->access_token;?>" size="55" /></td>
          </tr>
          <tr>
            <th><?php echo PLG_TW_TSECRET;?>:<?php echo required();?></th>
            <td><input name="access_secret" type="text" class="inputbox" value="<?php echo $twitt->access_secret;?>" size="55" /></td>
          </tr>
          <tr>
