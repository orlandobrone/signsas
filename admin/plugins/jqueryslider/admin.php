        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <label for="urltype-3"><?php echo PLG_JQ_NOLINK;?></label>
              <input name="urltype" type="radio" id="urltype-3" value="nourl" <?php getChecked($slrow['urltype'], "nourl");?> />
              </td>
          </tr>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <label for="urltype-3"><?php echo PLG_JQ_NOLINK;?></label>
              <input name="urltype" type="radio" id="urltype-3" value="nourl" checked="checked" />
              </td>
          </tr>
    ...
    <table class="display" id="pagetable">
      ...
      <tbody>
        ...
        <tr id="node-<?php echo $slrow['id'];?>">
          ...
          <td class="left"><?php if($slrow['urltype'] == "nourl"):?>-/-<?php else:?><a href="<?php echo $slrow['url'];?>"><?php echo $slrow['url'];?></a><?php endif;?></td>
